...
From APIM 3.7, you can use a custom prefix for your tables name.
...
1. Modify your `gravitee.yml` configuration files to configure `management.jdbc.prefix` and `ratelimit.jdbc.prefix`.
